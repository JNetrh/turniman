...
INSERT INTO `languages` (`id`, `code`, `name`, `img`, `position`, `display`) VALUES
(1, 'xx', 'universal', 'universal.png', 0, 0),
(2, 'cz', 'Čeština', 'cz.png', 1, 1);
...
(69, 'example@example.cz', '$2y$10$4iP5iusxv7MAYDaB92moYuZdhEK.51V4j9mv7pSQbJnjP5NBG4BMa');
...
ALTER TABLE `languages`
  ...
  ADD UNIQUE KEY `unique_language` (`code`);
